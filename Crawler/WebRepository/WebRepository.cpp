...
void WebRepository::save(const Website& website)
{
    ...
    auto updateFunction = [](const Website& website)
    {
        ...
        "$set" << bsoncxx::builder::stream::open_document << "lastUpdate" << website.getLastCrawlTime() << bsoncxx::builder::stream::close_document <<         
    ...
    auto insertFunction = [](const Website& website)
    {
        ...
        "lastUpdate" << website.getLastCrawlTime() << 
        bsoncxx::builder::stream::finalize;
...
std::vector<Website> WebRepository::getAll()
{
    ...
    for(auto doc : cursor)
    {
        ...
        time_t updated = doc["lastUpdate"].get_int64().value;
